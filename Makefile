...
HTTPS_GIT := github.com/rollchains/demospawnevmchain.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=demospawnevmchain \
...
ifeq (,$(shell which heighliner))
	...
	heighliner build -c demospawnevmchain --local -f chains.yaml
endif
